"""
Django settings for GRJOJ project.
...
EMAIL_HOST_PASSWORD = 'jhgg rpce xjxm meoa'  # Votre mot de passe d'application ou mot de passe normal
...
SECRET_KEY = 'django-insecure-260%5u@ny_80dk-tenv@9vzl09581(v@k^_8yrmk%v)p87cfoe'
...
WSGI_APPLICATION = 'GRJOJ.wsgi.application'
